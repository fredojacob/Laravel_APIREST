        ...
        <div class="flex-center position-ref full-height">
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    @else
                        <a href="{{ url('/helpdesk.create') }}">Login</a>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">CLites / Customers </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('cliente.store') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="second_name" class="col-md-4 col-form-label text-md-right">Apellido</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="mail" type="text" class="form-control @error('mail') is-invalid @enderror" name="mail" value="{{ old('mail') }}" required autocomplete="mail" autofocus>
